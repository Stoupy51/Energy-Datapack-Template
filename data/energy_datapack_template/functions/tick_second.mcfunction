...
#Others
	...
	execute as @a run function energy_datapack_template:opti/tick_second_players
...
#Custom Blocks
	...
	execute as @e[type=glow_item_frame,tag=energy_datapack_template.destroyer] at @s run function energy_datapack_template:opti/tick_second_glows
