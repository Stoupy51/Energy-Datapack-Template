...
execute if score #game_version load.status matches 2975.. if score SimplEnergy load.status matches 1090..1100 run tellraw @a[tag=convention.debug] {"text":"[Loaded Energy Datapack Template v1.0.0]","italic":false,"color":"green"}
