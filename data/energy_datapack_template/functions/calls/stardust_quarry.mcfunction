...
execute as @e[type=#energy:valid_block_entities,tag=energy_datapack_template.destroyer,distance=..1,limit=1] at @s run function energy_datapack_template:destroy/all
