...
#Tools/Equipments
	#Template Armor/Tools
		data modify storage energy_datapack_template:main all.XXX0100 set value {Slot:16b,id:"minecraft:leather_helmet"				,Count:1b,tag:{ctc:{id:"template_helmet",from:"your_name:energy_datapack_template",traits:{"armor":1b}}									,CustomModelData:XXX0100,energy_datapack_template:{template_helmet:1b}				,HideFlags:64,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Slot:"head",Amount:4,Operation:0,UUID:[I;201301,201301,201301,201302]}	,{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Slot:"head",Amount:2,Operation:0,UUID:[I;201301,201301,201302,201302]}]						,display:{color:3487029,Lore:['{"translate":"Energy Datapack Template","color":"blue","italic":true}']	,Name:'[{"text":"Template Helmet","italic":false,"color":"white"}]'}}}
		...
		data modify storage energy_datapack_template:main all.XXX0104 set value {Slot:16b,id:"minecraft:diamond_sword"				,Count:1b,tag:{ctc:{id:"template_sword",from:"your_name:energy_datapack_template",traits:{"tool":1b,"tool/weapon":1b}}					,CustomModelData:XXX0104,energy_datapack_template:{template_sword:1b}							 ,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Slot:"mainhand",Amount:8,Operation:0,UUID:[I;201305,201305,201305,201305]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Slot:"mainhand",Amount:-2.25,Operation:0,UUID:[I;201305,201305,201305,201306]}]		,display:{Lore:['{"translate":"Energy Datapack Template","color":"blue","italic":true}']				,Name:'[{"text":"Template Sword","italic":false,"color":"white"}]'}}}
		data modify storage energy_datapack_template:main all.XXX0105 set value {Slot:16b,id:"minecraft:diamond_pickaxe"			,Count:1b,tag:{ctc:{id:"template_pickaxe",from:"your_name:energy_datapack_template",traits:{"tool":1b,"tool/mining":1b}}				,CustomModelData:XXX0105,energy_datapack_template:{template_pickaxe:1b}				,display:{Lore:['{"translate":"Energy Datapack Template","color":"blue","italic":true}'],Name:'[{"text":"Template Pickaxe","italic":false,"color":"white"}]'}}}
		data modify storage energy_datapack_template:main all.XXX0106 set value {Slot:16b,id:"minecraft:diamond_axe"				,Count:1b,tag:{ctc:{id:"template_axe",from:"your_name:energy_datapack_template",traits:{"tool":1b,"tool/chopping":1b}}					,CustomModelData:XXX0106,energy_datapack_template:{template_axe:1b}					,display:{Lore:['{"translate":"Energy Datapack Template","color":"blue","italic":true}'],Name:'[{"text":"Template Axe","italic":false,"color":"white"}]'}}}
		data modify storage energy_datapack_template:main all.XXX0107 set value {Slot:16b,id:"minecraft:diamond_hoe"				,Count:1b,tag:{ctc:{id:"template_hoe",from:"your_name:energy_datapack_template",traits:{"tool":1b,"tool/tilling":1b}}					,CustomModelData:XXX0107,energy_datapack_template:{template_hoe:1b}					,display:{Lore:['{"translate":"Energy Datapack Template","color":"blue","italic":true}'],Name:'[{"text":"Template Hoe","italic":false,"color":"white"}]'}}}
		data modify storage energy_datapack_template:main all.XXX0108 set value {Slot:16b,id:"minecraft:diamond_shovel"				,Count:1b,tag:{ctc:{id:"template_shovel",from:"your_name:energy_datapack_template",traits:{"tool":1b,"tool/shovelling":1b}}				,CustomModelData:XXX0108,energy_datapack_template:{template_shovel:1b}				,display:{Lore:['{"translate":"Energy Datapack Template","color":"blue","italic":true}'],Name:'[{"text":"Template Shovel","italic":false,"color":"white"}]'}}}
